...
if __name__ == "__main__":
    print("Welcome to Ankur RodoSpeaker!")
    print("This robo speaker pronounced anything you want \n \t Type 'q' to exit.")
